...
describe('自動入力切り替えシステム', () => {
  ...
  describe('入力タイプ切り替えのルール', () => {
    ...
    describe('ルール2: ペンモード中の他入力の連続検知', () => {
      ...
      it('ペンモード中にmouse入力が閾値(7)に達すると、切り替え可能になる', () => {
        const { incrementConsecutiveInput, setInputType } = useUiStore.getState();
  ...
  describe('resetConsecutiveInput', () => {
    it('カウントと最後の入力タイプをリセットする', () => {
      const { incrementConsecutiveInput, resetConsecutiveInput } = useUiStore.getState();
    ...
    it('ペン入力検知時にリセットされる想定', () => {
      const { incrementConsecutiveInput, resetConsecutiveInput, setInputType } = useUiStore.getState();
  ...
  describe('入力タイプの変換', () => {
    it('pointerType "pen" → InputType "pen"', () => {
      ...
      const inputType = pointerType === 'touch' ? 'touch' :
  ...
  describe('ユーザー体験シナリオ', () => {
    it('シナリオ1: ペンタブレットユーザーがマウスに切り替える', () => {
      const { incrementConsecutiveInput, setInputType, resetConsecutiveInput } = useUiStore.getState();
    ...
    it('シナリオ3: ペン入力は即座に優先される', () => {
      const { setInputType, resetConsecutiveInput, incrementConsecutiveInput } = useUiStore.getState();
  ...
  describe('エッジケース', () => {
    ...
    it('入力タイプの切り替え後も状態が正しく管理される', () => {
      const { setInputType, incrementConsecutiveInput, resetConsecutiveInput } = useUiStore.getState();
